...
namespace Aksio.MongoDB.for_IgnoreConventionsAttributeFilter;

public class when_asking_should_include_for_convention_same_as_specified_in_ignore_attribute_on_type : Specification
{
    [IgnoreConventions("SomePack")]
    record TheType();
